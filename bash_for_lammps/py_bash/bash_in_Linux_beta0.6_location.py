...
Data_location = sys.path[0] + '/Data/ready_to_run/Formal_analysis/MSD/'
...
beta = []
beta_number = [0,0.1,0.2,0.5,1.0]#[0.1*i for i in range(2,3)]
beta_str = 'Beta'
...
gamma = []
gamma_number = ['300','20']#,'300']
gamma_str = 'Gamma'

particle_N = []
particle_N_number = ['4096']#'1024','4096',
particle_N_str = 'N'
...
for i in range(len(All_path)):
    ...
    try:
        ...
        print(e)
    shutil.copy(sys.path[0]+'/'+in_file_name,in_file_location)
...
for i in range(len(All_path)):
    ...
    try:
        ...
        os.rename(in_file_location+in_file_name,in_file_location+'py.'+in_file_name)
    except Exception as e:
        try:
            f.writelines('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n')
